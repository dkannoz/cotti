"use client"
/**
 * @fileoverview SVG map component used in the Map visualization.
 * Renders a detailed topographic-style map with animated gradient effects.
 * The map serves as the background for the activity indicators in the parent Map component.
 */
...
/**
 * @component SVGMap
 * @description A complex SVG map component that renders a stylized topographic representation
 * of agricultural land with animated gradient effects. The map consists of numerous path elements
 * that create the terrain contours and field boundaries.
 * 
 * The map serves as the visual foundation for the farm management visualization,
 * with numerous small path elements that create the terrain details. It uses
 * Framer Motion for gradient animations to create a subtle living effect.
 * 
 * @param {SVGProps<SVGSVGElement>} props - Standard SVG element props including className
 * @returns {JSX.Element} The rendered SVG map
 */
export const SVGMap = (props: SVGProps<SVGSVGElement>) => {
  ...
  return (
    ...
    >
      {/* 
        The following paths create the detailed terrain contour lines.
        Each path represents a specific elevation or boundary line on the map.
        They use a consistent stroke style with zinc-800 color for a dark, subtle appearance.
      */}
      <path
      ...
      />
      <path
        d="M267.417 64.7002L280.247 59.7145L293.5 52.8193L307.009 46.5099L320.615 48.7884"
        className="stroke-zinc-800"
        strokeWidth="0.5"
        strokeLinecap="round"
        strokeLinejoin="round"
 ...
 * @description Helper component that defines the color stops for the animated gradient.
 * Creates a subtle orange-to-transparent gradient effect that moves across the map.
 * 
 * @returns {JSX.Element} SVG gradient stop elements
 */
const GradientColors = () => {
  return (
    <>
      <stop offset="0" stopColor="rgb(234 88 12 / 0)" />
      <stop offset="0.2" stopColor="rgb(234 88 12 / 0.1)" />
      <stop offset="0.5" stopColor="rgb(234 88 12 / 0.2)" />
      <stop offset="0.8" stopColor="rgb(234 88 12 / 0.1)" />
      <stop offset="1" stopColor="rgb(234 88 12 / 0)" />
    </>
  )
}
